...
! function(a) {
    ...
    b.prototype = {
        ...
        findStructure: function() {
            this.container = a(this.options.container), this.lat = parseFloat(this.container.attr("data-lat")), this.lng = parseFloat(this.container.attr("data-lng")), this.coords = new google.maps.LatLng(this.lat, this.lng), this.zoom = parseInt(this.container.attr("data-zoom")), this.infoWindowContent = this.container.find(".map-info"), this.mapOptions = {
...
! function() {
    ...
    window.JQClass = function() {}, JQClass.classes = {}, JQClass.extend = function b(c) {
        ...
        a = !1;
        for (var f in c)
            if ("function" == typeof c[f] && "function" == typeof d[f]) e[f] = function(a, b) {
                return function() {
                    var c = this._super;
            ...
            else if ("object" == typeof c[f] && "object" == typeof d[f] && "defaultOptions" === f) {
            var j, g = d[f],
                h = c[f],
                i = {};
            for (j in g) i[j] = g[j];
        ...
        return k.prototype = e, k.prototype.constructor = k, k.extend = b, k
    }
}(),
function($) {
    "use strict";
